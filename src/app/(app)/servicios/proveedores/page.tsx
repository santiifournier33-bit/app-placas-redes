  ...
  return (
    <div className="max-w-5xl mx-auto p-4 lg:p-6">
      ...
      <div className="flex items-center justify-between mb-4">
        <h1 className="text-2xl font-bold text-shell-text">Proveedores</h1>
        <button
      ...
      <div className="flex items-center gap-2 mb-4">
        ...
        {usedCategories.length > 1 && (
          <select
            ...
            className="px-3 py-2 bg-white/[0.04] border border-white/[0.06] rounded-xl text-sm text-zinc-300 focus:outline-none [color-scheme:dark]"
          >
