  ...
  return (
    <div className="p-6 lg:p-8 max-w-7xl mx-auto">
      <div className="flex items-center gap-3 mb-2">
        <TaskSquare size={24} className="text-shell-accent" />
        <h1 className="text-2xl font-bold text-shell-text">Productividad</h1>
      </div>
      <p className="text-shell-text-muted text-sm mb-8">
        Tareas, actividad semanal, métricas y calendario del equipo.
      </p>
