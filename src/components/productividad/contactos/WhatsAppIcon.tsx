// Official WhatsApp glyph (single path). Inherits color via `currentColor` so
// callers control the tint (white on the brand-green circle in cards, green in
// the contact detail bar). Single source of truth for the logo across contacts.
