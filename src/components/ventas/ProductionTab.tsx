  ...
  return (
    <div className="space-y-6 relative">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <button onClick={fetchOperations} className="p-2 rounded-xl bg-shell-surface border border-shell-border text-shell-text-muted hover:text-shell-text transition-colors cursor-pointer">
        ...
        {isLoading ? (
          ...
          <div className="p-12 flex flex-col items-center justify-center text-center">
            <div className="w-16 h-16 rounded-full bg-white/5 flex items-center justify-center mb-4">
              <Building2 size={24} className="text-shell-text-muted" />
            </div>
            <h3 className="text-shell-text font-medium mb-1">No hay operaciones registradas</h3>
              ...
              >
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm font-semibold text-shell-text truncate">{op.property_address}</p>
                    <div className="flex items-center gap-4 mt-1.5 text-xs text-shell-text-muted">
                  ...
                  <div className="text-right shrink-0 flex flex-col items-end">
                    <p className="text-xs text-shell-text-muted">Honorarios</p>
        ...
        <div className="fixed inset-0 z-50 flex justify-end">
          ...
          <div className="relative w-full max-w-md bg-[#0c0c14] border-l border-shell-border h-full flex flex-col shadow-2xl animate-in slide-in-from-right-full duration-300">
            ...
            <div className="flex items-center justify-between p-5 border-b border-shell-border bg-white/[0.02]">
              ...
              <button onClick={() => setSelectedOperation(null)} className="p-2 rounded-xl hover:bg-white/[0.06] text-shell-text-muted cursor-pointer"><X size={16} /></button>
            </div>
            ...
            <div className="p-5 flex-1 overflow-y-auto space-y-6">
              ...
              <div className="space-y-3">
                <h4 className="text-xs font-bold text-shell-text uppercase tracking-wider border-b border-white/10 pb-2">Repartos Generales</h4>
                <div className="space-y-2">
                  <div className="flex justify-between items-center text-sm">
                    <span className="text-shell-text-muted">Oficina:</span>
                    <span className="font-bold text-shell-text">{selectedOperation.fee_currency} {selectedOperation.office_total_share.toLocaleString()}</span>
                  </div>
                  <div className="flex justify-between items-center text-sm">
                    <span className="text-shell-text-muted">Asesores:</span>
                    <span className="font-bold text-shell-text">{selectedOperation.fee_currency} {selectedOperation.agents_total_share.toLocaleString()}</span>
                  </div>
              ...
              {selectedOperation.operation_agents.length > 0 && (
                <div className="space-y-3">
                  <h4 className="text-xs font-bold text-shell-text uppercase tracking-wider border-b border-white/10 pb-2">Desglose Asesores</h4>
                  <div className="space-y-3">
                    {selectedOperation.operation_agents.map(oa => (
                      <div key={oa.id} className="bg-white/[0.02] border border-white/[0.05] p-3 rounded-xl">
              ...
              {selectedOperation.observations && (
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-shell-text-muted whitespace-pre-wrap">{selectedOperation.observations}</p>
                </div>
              )}
